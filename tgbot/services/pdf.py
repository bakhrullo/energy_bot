...
def pdf_create(number, name, signature, company_info):
    ...
    pdf.multi_cell(0, 5, txt=f"""                
                                                                 ДОГОВОР № {number}
                                                                (о поставке товаров)
    г. Андижан                                                                                                              {date.today().strftime('%d.%m.%Y')}.
    
ООО «STAR BEVERAGES», именуемое в дальнейшем "Поставщик", в лице директора Кучкарова А.Т., действующего на основании Устава, с одной стороны, и {company_info['shortName']}, именуемый в дальнейшем «Покупатель», в лице {company_info['director']}, действующего на основании Устава,с другой стороны, вместе именуемые «Сторона»ми заключили настоящий договор о нижеследующем:
    
1.1. Поставщик обязуется поставить Покупателю товар, а Покупатель обязуется принять и оплатить поставленный товар, в соответствии установленных условиях настоящим договором.
1.2. Наименование, цена и количество поставки партии товара определяются Спецификациями, которые будут оформляются частичными партиями, в соответствии полученного заказа от Покупателя (письменно или электронно) в течение срока действия настоящего Договора.
1.3. Каждая составленная спецификация будет подписываться обеими Сторонами, которые составляют неотъемлемую часть настоящего договора.

2. КОЛИЧЕСТВО, АССОРТИМЕНТ, КАЧЕСТВО И УПАКОВКА ТОВАРА
2.1. Покупатель после подписания настоящего договора представляет письменно или электронно список заказа на товар, а также согласует с Поставщиком срок поставки.
...
2.5. Заказ считается принятым, если после поставки товара в течение сутки со стороны Покупателя не будут возражения по заказу. 

3. СРОКИ, ПОРЯДОК ПОСТАВКИ И ПРИЕМА–СДАЧИ ТОВАРА
3.1. Поставка товара в течение срока действия настоящего договора производиться на основании составленной спецификации партиями из наличия товара на складе Поставщика.
...
4.1. Оплата поставки каждой партии товара определяется, согласно составленной спецификаций и производится Покупателем по общему правилу на условиях 100% предоплаты. Предоплата производится путем банковского перевода в течении пяти банковских дней с момента подписания спецификации.
4.2. Цена за единицу товара и общая стоимость товара на каждую поставку указывается сторонами в Спецификации переданных на основании счет-фактур с учетом НДС.
4.3. Цены на товар, подлежащий передаче по настоящему Договору, устанавливаются в сумах и действуют только на одну поставку.

5. ПРАВА И ОБЯЗАННОСТИ СТОРОН
5.1. Права и обязанности Поставщика:
5.1.1. В случае если Покупатель не выполнит свои обязательства указанный в пункте 4.1., настоящего договора или соответствующей спецификации, Поставщик имеет право изменить перечень товаров и цены указанных в спецификации;
5.1.2. В случаи отсутствия в наличии какого-либо ассортимента отгружаемого товара Поставщик может изменить товар на другую позицию;
5.1.3. Если были внесены изменения по причинам указанные в п.п. 5.1.2. Поставщик обязуются согласовать Покупателем обновлённую спецификацию;
...
5.2.1. В случае если не выполнит свои обязательства по предоплате в срок, указанный в пункте 4.1., настоящего договора или соответствующей спецификации, стоимость товара может быть изменена Поставщиком в одностороннем порядке;
5.2.2. В случаи несоблюдение Поставщиком обязательство согласно п.5.1.3. Покупатель имеет право требовать замены товара;
...
5.2.4. Несёт ответственность за достоверность предоставленные документы при заключении настоящего договора, оформлении спецификации или передаче товара;
...
6.3. В случае несоблюдения Покупателем сроков оплаты, Поставщик имеет право остановить все отгрузки по согласованный в соответствии спецификации.
6.4. После передачи товара Поставщиком, ответственность за полученный товар несет Покупатель.
6.5. В случае нарушения условий пункта 6.6. Покупатель в соответствии законодательства несет ответственность перед Поставщиком, а также обязуется выплатить штраф Поставщику в размере 50 БРВ.
